                        ...
                        <form action="{{ route('admin.pre-registers.update', $preregister) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col">
                                        <label for="employee_id">{{ __('Pilih Karyawan') }}</label> <span class="text-danger">*</span>
                                ...
                                <div class="form-row">
                                    <div class="form-group col">
                                        <label>{{ __('Tanggal Diharapkan') }}</label> <span class="text-danger">*</span>
                                    ...
                                    <div class="form-group col">
                                        <label for="expected_time">{{ __('Waktu Diharapkan') }}</label> <span class="text-danger">*</span>
                                ...
                                <div class="form-row">
                                    <div class="form-group col">
                                        <label for="comment">{{ __('Keterangan') }}</label>
