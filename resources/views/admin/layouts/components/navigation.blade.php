        ...
        <li class=" hidecheck "  >
            ...
            {{ csrf_field() }}
                <div class="d-flex form-group  {{ $errors->has('first_name') ? 'has-error' : ''}}" style="margin-bottom: -24px;margin-left:auto"    >
                    <input  class="form-control inputid"  style="margin-right: 5px;" type="text" name="visitorID"  placeholder="Masukkan ID Karttu">
                    <button   class="btn  d-flex inputbtn align-items-center" type="submit"><i class="fas fa-4x fa-sign-out-alt"></i>Keluar</button>
                </div>
            </form>
        </li>
