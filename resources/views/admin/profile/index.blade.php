                    ...
                    <div class="card profile-widget">
                        ...
                        <div class="profile-widget-description">
                            ...
                            <dl class="row">
                                ...
                                <dt class="col-sm-3">{{ __('Telepon') }}</dt>
                    ...
                    <div class="card">
                        <form method="post" action="{{ route('admin.profile.change') }}">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="form-group col-md-12 col-12">
                                        <label for="old_password">{{ __('Password Lama') }}</label> <span class="text-danger">*</span>
                                    ...
                                    <div class="form-group col-md-12 col-12">
                                        <label for="password_confirmation">{{ __('Konfirmasi Password') }}</label> <span class="text-danger">*</span>
                            ...
                            <div class="card-footer">
                                <button class="btn btn-primary">{{ __('Simpan Password') }}</button>
                            </div>
                        </form>
                    </div>
                </div>
                            ...
                            <div class="card-body">
                                <div class="form-row">
                                    <div class="form-group col">
                                        <label>{{ __('Nama Depan') }}</label> <span class="text-danger">*</span>
                                    ...
                                    <div class="form-group col">
                                        <label>{{ __('Nama Belakang') }}</label> <span class="text-danger">*</span>
