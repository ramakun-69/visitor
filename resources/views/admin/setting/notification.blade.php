            ...
            <div class="card-body">
                <form class="form-horizontal" role="form" method="POST" action="{{ route('admin.setting.notification-update') }}">
                     ...
                     <fieldset class="setting-fieldset">
                        <legend class="setting-legend">{{ __('Pengaturan Notifikasi') }}</legend>
                         <div class="row">
                             <div class="col-md-6">
                                 <div class="form-group" id="">
                                     <label class="control-label" for="defaultUnchecked">{{__('Notifikasi Email')}}</label>
                             ...
                             <div class="col-md-6">
                                 <div class="form-group" id="">
                                     <label class="" for="defaultUnchecked">{{__('Notifikasi SMS')}}</label>
                                     <div class="form-check">
                                         <label class="form-check-label">
