        ...
        <div class="card-body">
            <form class="form-horizontal" role="form" method="POST" action="{{ route('admin.setting.site-update') }}"
                ...
                <fieldset class="setting-fieldset">
                    <legend class="setting-legend">{{ __('Pengaturan Umum') }}</legend>
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                <label
                                    for="site_phone_number">{{ __('Nomor Telpon') }}</label>
                                <span class="text-danger">*</span>
                            ...
                            <div class="form-group">
                                <label for="site_address">{{ __('Alamat') }}</label> <span
                                    class="text-danger">*</span>
                            ...
                            <div class="form-group">
                                ...
                                <div class="custom-file">
                                    ...
                                    <label class="custom-file-label" for="customFile">{{ __('Pilih
                                                                    file') }}</label>
                                </div>
                                @error('site_logo')
                                <div class="invalid-feedback">
