            ...
            <div class="card-body">
                <form class="form-horizontal" role="form" method="POST" action="{{ route('admin.setting.homepage-update') }}">
                     ...
                     <fieldset class="setting-fieldset">
                        <legend class="setting-legend">{{ __('Pengaturan Front-End') }}</legend>
                         <div class="row">
                             <div class="col-md-6">
                                 <div class="form-group" id="">
                                     <label class="control-label" for="defaultUnchecked">{{__('Aktifkan Front-end ')}}</label>
                             ...
                             <div class="col-md-6">
                                 <div class="form-group" id="">
                                     <label class="control-label" for="defaultUnchecked">{{__('Persetujuan Visitor ')}}</label>
                                     <div class="form-check">
                                         <label class="form-check-label">
                    ...
                    <fieldset class="setting-fieldset">
                        <legend class="setting-legend">{{ __('Pengaturan Welcome Screen') }}</legend>
                        <div class="row">
                            <div class="col-md-12">
                    ...
                    <fieldset class="setting-fieldset">
                        <legend class="setting-legend">{{ __('Pengaturan Syarat & Ketentuan') }}</legend>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
