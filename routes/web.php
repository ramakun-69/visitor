...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'installed','backend_permission'], 'namespace' => 'Admin', 'as' => 'admin.'], function () {
    ...
    Route::get('get-active-visitors', 'ActiveVisitorController@getVisitor')->name('visitors.get-active-visitors');

    // Visit Place
    Route::resource('visitPlace', 'VisitPlaceController');
    Route::get('get-visitPlace', 'VisitPlaceController@getVisitPlace')->name('visitPlace.get-visitPlace');
    // Visit Place
